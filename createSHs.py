...
for inHAB in inHABs:
    ...
    cursor.execute("""CREATE TABLE dis_pts_2500_10x10."""+str(inHAB)+"""_starthabitas (sh_1 BIGINT, sh_2 BIGINT, sh_3 BIGINT, sh_4 BIGINT, sh_5 BIGINT, sh_6 BIGINT, sh_7 BIGINT, sh_8 BIGINT, sh_9 BIGINT, sh_10 BIGINT);""")
    ...
    cursor.execute("""INSERT INTO dis_pts_2500_10x10."""+str(inHAB)+"""_starthabitas (sh_1, sh_2, sh_3, sh_4, sh_5, sh_6, sh_7, sh_8, sh_9, sh_10) values """+toINS_list_SH+""";""")  
