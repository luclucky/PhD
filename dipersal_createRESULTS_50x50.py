...
def dispersal_MODEL(inSP):
    ...
    for inHAB in inHABs:
        ...
        for z in range(10):
            ...
            cursor.execute("""SELECT st_extent(geom) FROM stream_network_10x10."""+str(inHAB)+"""_start_"""+str(z)+""";""")
            ...
            cursor.execute("""SELECT * FROM res_shequal_50x50."""+str(inHAB)+"""_starthabitas;""")
...
#             raster_MD = [float(x) for x in raster_MD[0][1][1:-1].split(',')]
            ...
            for zz in range(10):
                ...
                cursor.execute("""SELECT start, aim, costs FROM stream_network_10x10."""+str(inSP)+"""_50x50_"""+str(zz)+"""_"""+str(inHAB[22:])+"""_start_"""+str(z)+""";""")
